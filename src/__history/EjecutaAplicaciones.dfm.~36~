object frmExecApp: TfrmExecApp
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'NLND-Ejecuta Aplicaciones'
  ClientHeight = 399
  ClientWidth = 831
  Color = clBtnFace
  ...
  object pnlRight: TPanel
    ...
    object mmo1: TMemo
      ...
      Height = 89
      Lines.Strings = (
        'No es la version final pero '
        'funciona...'
        '')
      TabOrder = 1
    end
    object edthola: TEdit
      Left = 5
      Top = 112
      Width = 169
      Height = 21
  ...
  object pnlCenter: TPanel
    ...
    object grdExecApp: TCRDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = grdExecAppCellClick
      Columns = <
        item
          Expanded = False
          FieldName = 'NOMBRE_APP'
  ...
  object qExecApp: TUniQuery
    Connection = DM.DBNLND
    SQL.Strings = (
      'SELECT * FROM EJECUTA_APLICACIONES')
    AfterInsert = qExecAppAfterInsert
    AfterEdit = qExecAppAfterEdit
    BeforePost = qExecAppBeforePost
    AfterPost = qExecAppAfterPost
    AfterCancel = qExecAppAfterCancel
    Left = 48
    Top = 128
    object qExecAppID: TIntegerField
      FieldName = 'ID'
      ReadOnly = True
      Required = True
    end
    object qExecAppID_USUARIO: TIntegerField
      FieldName = 'ID_USUARIO'
      Required = True
    end
    object qExecAppNOMBRE_APP: TStringField
      FieldName = 'NOMBRE_APP'
      Required = True
      Size = 250
    end
    object qExecAppRUTA: TStringField
      FieldName = 'RUTA'
      Size = 250
    end
    object qExecAppICONO: TStringField
      FieldName = 'ICONO'
      Size = 250
    end
  end
  object dsExecApp: TDataSource
    AutoEdit = False
    DataSet = qExecApp
    Left = 112
    Top = 128
