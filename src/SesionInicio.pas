        ...
        begin
          ...
          try
           ...
           RandomMize;
            ...
            Application.MessageBox('NLND te ha enviado un correo con un código en ella'
              + #13#10 + 'para que puedas confirmar tu E-MAIL...' + #13#10 +
              #13#10 +
              'Dentro de la aplicación estara habilitado el espacio luego ' +
              #13#10 + 'de iniciar sesión', 'NLND-Aviso', MB_OK +
...
begin
  ...
  begin
    edtEmail.Height := 30;
    edtPass.Height := 30;
    InicioSesion.Caption := 'NLND-Inicio de sesión';
  end;
